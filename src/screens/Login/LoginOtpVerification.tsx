...
import { View, Text, TouchableOpacity, KeyboardAvoidingView, Platform, StyleSheet, SafeAreaView } from 'react-native';
import {
    usePrivy,
    useEmbeddedWallet,
    isNotCreated,
    ...
    >
        <SafeAreaView style={styles.safeAreaContainer}>
            ...
            <StatusModal
                ...
                text={modalState === 'loading' ? loadingMessage : t("loginWithEmail.errorCodeText")}
                onClose={() => {
                    setModalState('dismissed');
                    setCode("");
                    navigation.navigate("LoginWithEmail");
