      ...
      <View style={styles.content}>
        <View style={styles.recipientContainer}>
          ...
          <Text style={styles.recipient}>
            {recipientCrypto?.name ||
              shortenAddress(recipientCrypto?.address as Address)}
          </Text>
        </View>
        ...
        <View style={styles.amountWrapper}>
          ...
          <View style={styles.amountContainer}>
            <Text style={[styles.amountPrefix, { fontSize: fontSize * 0.4 }]}>
              $
            </Text>
          ...
          <View style={styles.errorContainer}>
            <Text
              style={
                !hasEnoughBalance ? styles.errorText : styles.errorInvisibleText
              }
            >
