      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContainer}>
          ...
          <View style={styles.detailsContainer}>
            <DetailRow
              label={t("sentReceipt.date")}
              value={transfer.created_at}
            />
            {/* <DetailRow label={t("sentReceipt.accountNumber")} value={recipient?.external_account?.account_number ?? ""} /> */}
            <DetailRow
              label={t("sentReceipt.reference")}
              value={truncateId(transfer.id)}
            />
            <DetailRow
              label={t("sentReceipt.status")}
              value={transfer.status}
              valueStyle={styles.statusText}
            />
          </View>
