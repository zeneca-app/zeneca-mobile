...
import type {
  ...
  CustomersCreateCustomerError,
  CustomersCreateCustomerResponse,
  CustomersGetBalanceError,
  CustomersGetBalanceResponse,
  CustomersGetCustomerError,
  CustomersGetCustomerResponse,
  LoginAuthenticateData,
 ...
 * Authenticate
 */
export const loginAuthenticate = <ThrowOnError extends boolean = false>(
  options: Options<LoginAuthenticateData, ThrowOnError>,
) => {
  return (options?.client ?? client).post<
    LoginAuthenticateResponse,
    LoginAuthenticateError,
 ...
 * Get current user.
 */
export const customersGetCustomer = <ThrowOnError extends boolean = false>(
 ...
 * Create Customer
 */
export const customersCreateCustomer = <ThrowOnError extends boolean = false>(
  options: Options<CustomersCreateCustomerData, ThrowOnError>,
) => {
  return (options?.client ?? client).post<
    CustomersCreateCustomerResponse,
    CustomersCreateCustomerError,
 ...
 */
export const customersGetBalance = <ThrowOnError extends boolean = false>(
  options?: Options<unknown, ThrowOnError>,
) => {
  return (options?.client ?? client).get<
    CustomersGetBalanceResponse,
 ...
 * New Event Received
 */
export const webhooksNewEventReceived = <ThrowOnError extends boolean = false>(
  options?: Options<unknown, ThrowOnError>,
) => {
  return (options?.client ?? client).post<
    WebhooksNewEventReceivedResponse,
