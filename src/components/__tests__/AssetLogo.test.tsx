...
describe("AssetLogo", () => {
  describe("Logo Source Selection", () => {
    ...
    it("renders custom fallback when provided", () => {
      ...
      render(
        <AssetLogo symbol="INVALID" fallbackComponent={<CustomFallback />} />,
      );
    ...
    it("renders URL-based logo when provided", () => {
      const { UNSAFE_getByType } = render(
        <AssetLogo symbol="BTC" logoUrl="https://example.com/btc.png" />,
      );
  ...
  describe("Error Handling", () => {
    ...
    it("handles failed image loads", () => {
      const { UNSAFE_getByType } = render(
        <AssetLogo symbol="BTC" logoUrl="https://example.com/invalid.png" />,
      );
      const image = UNSAFE_getByType("Image");
