...
const FullAddressStep = ({
  ...
  const validationSchema = z.object({
    address_street_1: z
      ...
      .min(
        5,
        t("onBoarding.full_address.address_street_1_field.error_required"),
      )
      .max(
        50,
        t("onBoarding.full_address.address_street_1_field.error_invalid"),
      ),
    address_city: z
      .string()
  ...
  return (
    <>
      ...
      <InputWrapper
        ...
        isFocused={
          focused === "address_state" || Boolean(formValues.address_state)
        }
